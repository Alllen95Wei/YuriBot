                ...
                if parameter == "":
                    ...
                    if parameter[:4] == "help":
                        ...
                        embed.add_field(name="程式碼與授權", value="程式碼可在[GitHub](https://github.com/Alllen95Wei/YuriBot)查看。"
                                                             ...
                                                             "(https://github.com/Alllen95Wei/YuriBot/blob/master"
                                                             "/LICENSE)查看條款。")
                        ...
                        embed = discord.Embed(title="錯誤", description="參數`{0}`不存在。請輸入`y!help`來查看說明。"
                                              .format(parameter), color=0xF1411C)
                        final_msg_list.append(embed)
